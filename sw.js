const CACHE='bitacora-v5-3-photo-first';
const ASSETS=['./','./index.html','./styles.css','./app.js','./data.js','./photo-data.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./icon-1024.png','./splash-vw340.jpg'];
